        ...
        {hasStarted && !hasEnded && !confirmed ? (
          <div className="absolute right-4 top-4 z-10 flex gap-2">
            ...
            <Button
              type="button"
              onClick={handleCall}
              className="h-10 rounded-full px-5 text-sm font-bold backdrop-blur-md transition-colors border border-white/30"
              style={{ backgroundColor: ctaDarkColor, color: ctaTextColor, boxShadow: `0 8px 20px ${ctaColor}66`, textShadow: ctaTextColor === '#ffffff' ? '0 1px 2px rgba(0,0,0,0.2)' : 'none' }}
            >
          ...
          >
            <div
              style={{
                ...
                textAlign: "center",
                letterSpacing: "-0.02em",
                textShadow: ctaTextColor === "#ffffff" ? "0 4px 12px rgba(0,0,0,0.15)" : "none",
                fontFamily: "figtreeregular, Inter, sans-serif",
              }}
            >
        ...
        {showAvail ? (
          ...
          >
            <div className="button__wrapper">
              ...
              <button
                type="button"
                className="absolute inset-0 z-10 flex items-center justify-center rounded-full transition-all border-0 premium-btn-inner"
                style={{
                  background: `linear-gradient(135deg, ${ctaColor}, ${ctaDarkColor})`,
                  color: ctaTextColor,
                  textShadow: ctaTextColor === '#ffffff' ? '0 1px 3px rgba(0, 0, 0, 0.3)' : 'none',
        ...
        {(showSelector || showSelectorsOverlay) && !confirmed && selectedRow ? (
          ...
          >
            <div className="button__wrapper">
              ...
              <button
                type="button"
                className="absolute inset-0 z-10 flex items-center justify-center rounded-full transition-all border-0 premium-btn-inner px-2"
                style={{
                  background: `linear-gradient(135deg, ${ctaColor}, ${ctaDarkColor})`,
                  color: ctaTextColor,
                  textShadow: ctaTextColor === '#ffffff' ? '0 1px 3px rgba(0, 0, 0, 0.3)' : 'none',
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center bg-slate-950/18 px-6 backdrop-blur-[2px] animate-in fade-in zoom-in-95 duration-300">
            <div className="relative w-full overflow-hidden rounded-[2rem] border border-white/70 bg-white/95 p-6 text-center shadow-2xl">
              ...
              <Button
                type="button"
                onClick={handleCall}
                className="relative mt-5 h-14 w-full rounded-full text-base font-black shadow-xl border-0"
                style={{ background: `linear-gradient(135deg, ${ctaColor}, ${ctaDarkColor})`, color: ctaTextColor }}
              >
        ...
        {hasEnded && !selectedRow ? (
          <div className="absolute inset-x-5 bottom-10 flex flex-col gap-3 animate-in fade-in zoom-in duration-300 z-20">
            <Button
              type="button"
              onClick={handleCall}
              className="h-14 w-full rounded-full text-base font-bold shadow-2xl ring-4 ring-white/20 border-0"
